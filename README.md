...
This bindings have been autogenerated from the [official KTX C header](https://github.com/KhronosGroup/KTX-Software/blob/main/lib/include/ktx.h) using [CppAst.NET](https://github.com/xoofx/CppAst.NET).
